...
export function getVolunteerRecommendation(studentId) {
  return request({
    url: '/api/recommendation/volunteer',
    method: 'get',
    params: { studentId }
  })
}
...
export function checkVolunteerConflict(studentId) {
  return request({
    url: '/api/recommendation/conflict',
    method: 'get',
    params: { studentId }
  })
}
...
export function predictAdmissionProbability(studentId, universityId, majorId) {
  return request({
    url: '/api/recommendation/probability',
    method: 'get',
...
export function analyzeMajorEmployment(majorId) {
  return request({
    url: '/api/recommendation/employment',
    method: 'get',
    params: { majorId }
  })
}
...
export function analyzeProvinceScore(provinceId, disciplineCategoryId) {
  return request({
    url: '/api/recommendation/province',
    method: 'get',
...
export function analyzeVolunteerComprehensive(studentId) {
  return request({
    url: '/api/recommendation/comprehensive',
    method: 'get',
    params: { studentId }
  })
}
